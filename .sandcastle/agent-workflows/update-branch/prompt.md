...
Read `.sandcastle/PROJECT.md` (the project map and the docs it points to) before resolving anything substantive.
...
After resolving, run whatever checks you think are warranted — the commands live in `.sandcastle/PROJECT.md`. You decide how far to go. If something is broken, fix what you can; if you can't, push what you have and flag it clearly in the comment.
